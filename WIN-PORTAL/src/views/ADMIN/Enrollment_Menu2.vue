  ...
  created() {
    ...
    this.gridProps = {
      ...
      columns: [
        ...
        { header: "메뉴권한", name: "MENU_AUTH", align: "center", width: "100",  ellipsis:true, editor:{type:'select', options:{listItems:[{text:'관리자', value:'A01'}, {text:'로그인유저', value:'A02'}, {text:'일반사용자', value:'A03'}]}}},
