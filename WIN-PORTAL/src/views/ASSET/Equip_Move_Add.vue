        ...
        <fieldset>
          <div class="row">
            ...
            <div class="col-md-12 col-sm-6">
              ...
              <div class="col-md-11 col-sm-8 col-xs-8">
                <b-form-input id="CHARGE_PM_ID" v-model="LB_CHARGE_PM_TXT" ref = "CHARGE_PM"  @click="CHARGE_SELECT" ></b-form-input>
              </div>
            </div>
            <div class="col-md-12 col-sm-6">
...
import {NEW_MOVE_NO,SAVE_EQUIP_MOVE} from "@/api/Equip_Move.js";
import {NEW_RNF_CD,ASSET_OUT_SAVE,ASSET_SELECT_DST_OUT,ASSET_SELECT_MNT_OUT} from "@/api/Asset_Out.js"; 
...
export default {
  ...
  methods: {
    ...
    async SEARCH_LIST(){
        ...
        let DST_LIST = await ASSET_SELECT_DST_OUT(this.LB_RNF_CD_TXT);
        ...
        let MNT_LIST = await ASSET_SELECT_MNT_OUT(this.LB_RNF_CD_TXT);
           // 조회된 데이터가 null이거나 undefined 인 경우
          ...
          if(msgBox) // 저장 알림창 확인버튼
          {
            ...
            for(var i=0; i<this.SELECTED_ASSET.length; i++)
            {
              ...
              data[i]= {data: JSON.stringify({
                                                MOVE_NO : this.LB_RNF_CD_TXT.toString(),        //입출고코드
              ...
              // 저장 결과를 변수에 담는다. 
              let asset_save = await SAVE_EQUIP_MOVE(Save_Data);
